...
class BerkasController extends Controller
{
    ...
    public function berkas(Request $request){
     ...
     public function confirmed_I(Request $request, $data){
        ...
        $data->date_konfirmasi= Carbon::now()->format('Y-m-d H:i:s');
        $data->update();
    ...
    //  }
     ...
     public function dataConfirmedI(){
        $data = Data::where('confirmed_I','1')->where('confirmed_II')->get();
     ...
     public function dataConfirmedII(){
         $data = Data::where('confirmed_II','1')->where('confirmed_I','1')->get();
         if ($data) {
            return response()->json([
                'status'=> true,
                'message'=>'data tampil',
    ...
    //melihat data
     ...
     public function dataReport(){
         $data = Data::whereNotNull('report')->where('confirmed_II')->get();
         if ($data) {
             # code...
             return response()->json([
                 'status'=> true,
     ...
     public function dataReportII(){
        $data = Data::whereNotNull('report')->where('confirmed_I','1')->where('confirmed_II','1')->where('confirmed_II','0')->get();
        if ($data) {
            # code...
            return response()->json([
                'status'=> true,
