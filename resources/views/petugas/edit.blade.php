                    ...
                    <form class="form-horizontal" method="post" action="{{route('petugas.update',[$petugas->id])}}">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="username" disabled value="{{$petugas->username}}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="nama_pegawai" class="col-sm-2 control-label">Nama Petugas</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" maxlength="50" placeholder="Maksimal karakter adalah 50" id="nama" name="nama" value="{{$petugas->nama}}">
                                </div>
                            </div>
                        </div>
